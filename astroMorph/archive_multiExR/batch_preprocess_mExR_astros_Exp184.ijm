...
// Last modified by MES on 11/27/24
...
parent = "A:/Margaret/Astrocytes/Exp184_multiExR_astros/"; //parent folder where raw microscope images are stored (e.g. in .nd2 format)
parentout = "A:/Margaret/Astrocytes/Exp184_multiExR_astros/preprocessed/"; //where to save the images

roundList = newArray("round1.2/"
					//"round2/",
					//"round3/",
				//	"round4/",
				//	"round5/",
...
function preprocessImage(imageFile,folder,roundno)
{
	...
	//roundid="round006"; //hard-coded for the round without GFAP and SMI (R1.1)
	//newname = title;
